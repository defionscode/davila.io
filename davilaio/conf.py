...
BLOG_AUTHOR = "Jonathan I. Davila"  # (translatable)
...
# (translatable)
LICENSE = "<a href='/LICENSE'> GPLv2</a>"
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> under {license}'
